  ...
  return (
    <div className="min-h-screen bg-[#FFF4F5] text-[#4A3538] flex flex-col items-center justify-start pt-6 pb-28 px-4 md:px-8 font-sans antialiased space-y-8">
      ...
      <header className="w-full max-w-3xl flex justify-between items-start px-2">
        ...
        <div className="px-5 py-1.5 rounded-full bg-white/50 border border-[#FFE0E4] text-[10px] font-light text-[#FF94A5] tracking-wider flex items-center space-x-1 shadow-sm">
          <span>Remember who you are</span>
        </div>
      </header>

      {/* Main Structural Assembly Layout Card Stack Grouping */}
      <div className="w-full max-w-3xl flex flex-col items-center space-y-4">
        ...
        {activeTab === 'today' ? (
          ...
          <div className="w-full min-h-[280px] bg-white/60 backdrop-blur-md rounded-[32px] p-8 border border-white/40 shadow-sm flex items-center justify-center">
            <p className="text-[#4A3538]/60 italic">Graph summary parameters active...</p>
          </div>
        )}
      </div>
